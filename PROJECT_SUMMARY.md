...
### Утилитные классы
- `SystemNameUtils` - утилиты для работы с названиями систем (валидация шаблонов, извлечение префиксов, санитизация)
- `DateTimeUtils` - утилиты для работы с датой и временем (форматтеры для единообразия)
