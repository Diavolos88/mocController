...
**Функционал:**
- Создание групп с названием, описанием и списком систем
- Редактирование существующих групп (название, описание, список систем)
- Удаление групп с подтверждением
- Отображение всех групп с информацией о количестве систем в каждой группе
...
- **Если у заглушки остается 0 подов:** Заглушка отображается на странице статусов с 0 подов (0 онлайн, 0 офлайн), чтобы было видно, что все поды упали. Это позволяет быстро определить проблемные заглушки, у которых все поды неактивны
- Заглушки с 0 подов отображаются только если они зарегистрированы в системе через конфиги
- Время офлайн и время очистки можно настроить в `application.yml` (см. раздел "Конфигурация приложения")
- Страница автоматически обновляется каждые 30 секунд
